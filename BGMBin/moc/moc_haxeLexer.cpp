...
struct qt_meta_stringdata_HaxeLexer_t {
    QByteArrayData data[1];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_HaxeLexer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_HaxeLexer_t qt_meta_stringdata_HaxeLexer = {
    {
QT_MOC_LITERAL(0, 0, 9) // "HaxeLexer"
...
const QMetaObject HaxeLexer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_HaxeLexer.data,
      qt_meta_data_HaxeLexer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HaxeLexer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HaxeLexer.stringdata0))
