...
static const char qt_meta_stringdata_Titlebar[] = {
    "Titlebar\0\0closeCurrentDockument()\0"
    "closeCurrentDocumentClicked()\0"
};
...
static const char qt_meta_stringdata_CentralWidget[] = {
    "CentralWidget\0\0currentChanged(int)\0"
    "closeCurrentDocument(int)\0index\0"
    "indexChanged(int)\0closeCurrentDocumentClicked()\0"
};
