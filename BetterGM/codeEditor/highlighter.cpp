...
Highlighter::Highlighter(QTextDocument *parent, bool chat) :
    QSyntaxHighlighter(parent)
{
    ...
    keywordPatterns << "\\band\\b" << "\\bbool\\b" << "\\bbreak\\b" << "\\bcase\\b" << "\\bcast\\b" << "\\bclass\\b"
                    ...
                    << "\\bget\\b" << "\\bif\\b" << "\\bimport\\b" << "\\binout\\b" << "\\bint\\b" << "\\binterface\\b"
                    << "\\bint8\\b" << "\\bint16\\b" << "\\bint32\\b" << "\\bint64\\b" << "\\bis\\b" << "\\bmixin\\b" << "\\bwith\\b"
                    << "\\bnamespace\\b" << "\\bnot\\b" << "\\bnull\\b" << "\\bor\\b" << "\\bout\\b" << "\\boverride\\b" << "\\brepeat\\b"
    ...
    classPatterns << "\\bint\\b" << "\\bfloat\\b" << "\\bdouble\\b" << "\\bbool\\b"  << "\\bvoid\\b" << "\\bstring\\b"
                  << "\\benum\\b" << "\\bclass\\b" << "\\bglobal\\b" << "\\bx\\b" << "\\by\\b" << "\\bspeed\\b"
                  << "\\bid\\b" << "\\bvspeed\\b" << "\\bhspeed\\b" << "\\bspeed\\b" << "\\bdirection\\b";
